...
import { ClientEventFinder, EventProcessSteps, GameEventIdentifiers, ServerEventFinder } from 'src/core/event/event';
import { EventPacker } from 'src/core/event/event_packer';
import { AllStage, PlayerPhase, StagePriority } from 'src/core/game/stage_processor';
...
export abstract class ActiveSkill extends Skill {
  ...
  public abstract canUse(_room: Room, _owner: Player, _containerCard?: CardId): boolean;
