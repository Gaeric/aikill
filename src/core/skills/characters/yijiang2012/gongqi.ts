...
import { INFINITE_ATTACK_RANGE, INFINITE_TRIGGERING_TIMES } from 'src/core/game/game_props';
...
import { ActiveSkill, CommonSkill, OnDefineReleaseTiming, RulesBreakerSkill, TriggerSkill } from 'src/core/skills/skill';
