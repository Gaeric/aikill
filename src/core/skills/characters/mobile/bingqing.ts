import { CardChoosingOptions, CardSuit } from 'src/core/cards/libs/card_props';
...
import { AllStage, CardUseStage, PhaseChangeStage, PlayerPhase, StagePriority } from 'src/core/game/stage_processor';
