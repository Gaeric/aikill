...
export class DevImageLoader implements ImageLoader {
  ...
  public getBackgroundImage() {
    return { alt: "", src: `${cosRepo}/images/system/background.jpg` };
  }
  ...
  public async getSlimAbortedEquipSection(section: CharacterEquipSections) {
    ...
    // let imageUrl = cosRepo + "/images/slim_equips/" + sectionName + ".png";
    // const image: string = (await import(imageUrl)).default;
    return { alt: "Aborted Slim Equip Card", src: "" };
  }
